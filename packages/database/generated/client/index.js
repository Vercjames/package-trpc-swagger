...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/vercjames/trpc-swagger/packages/database/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/vercjames/trpc-swagger/packages/database/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "trpc-swagger/packages/database/generated/client",
...
path.join(process.cwd(), "trpc-swagger/packages/database/generated/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "trpc-swagger/packages/database/generated/client/schema.prisma")
